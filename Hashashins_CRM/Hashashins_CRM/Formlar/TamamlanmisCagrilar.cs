...
{
    public partial class TamamlanmisCagrilar : DevExpress.XtraEditors.XtraForm
    {
        ...
        void PasifCagrilariListele()
        {
            ...
            gridControl1.DataSource = degerler.Where(x => x.Durum == false).ToList();
            gridView1.Columns[0].Visible = false;
            gridView1.Columns[4].Visible = false;
        }
            private void TamamlanmisCagrilar_Load(object sender, EventArgs e)
        {
            PasifCagrilariListele();
        }
